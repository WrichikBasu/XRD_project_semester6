...
According to the standards set by IUCr, for $\mathrm{Mo}~K_\alpha$ radiation, data has to be recorded \ifnt{at least} up to $\SI{50}{\degree}$ in $2\theta$ for an acceptable crystal structure solution.
